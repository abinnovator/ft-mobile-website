...
export default function Home() {
  return (
    <div className="bg-[#fef7ef] h-screen font-(family-name:--font-satoshi)">
...
<br /> <span className="text-[#e85464]">right from your phone</span></h1>
      ...
      <div className="flex flex-row gap-10 items-center justify-center pt-10 motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-95 motion-safe:duration-700 motion-safe:delay-200 motion-reduce:animate-none">
        <Button className="border-2 border-gray-400 px-10 py-7 rounded-full cursor-pointer bg-[#338EDA]">Download Now!</Button>
      </div>
      <FeaturesSection />
    </div>
  );
